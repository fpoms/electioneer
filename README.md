...
get the app created:
    ...
    $ heroku apps:create electioneer
    Creating electioneer... done, stack is cedar
    http://electioneer.herokuapp.com/ | git@heroku.com:electioneer.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://electioneer.herokuapp.com deployed to Heroku

    To git@heroku.com:electioneer.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://electioneer.herokuap.com
    ["Hello" :from Heroku]
